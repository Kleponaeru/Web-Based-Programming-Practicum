...
<body>
    <div class="container-fluid d-flex justify-content-center align-items-center border vh-100">
        <div class="card w-25">
            <div class="card-header bg-primary d-flex justify-content-center"><strong class="text-light">LOGIN FORM</strong></div>
            <div class="card-body">
                <form action="/ceklogin" method="POST">
                    @csrf
                    <div class="form-group">
                        <label>Username</label>
                        <input type="text" name="nama_user" placeholder="Input Username" class="form-control" required>
                    </div>
                    <div class="form-group">
